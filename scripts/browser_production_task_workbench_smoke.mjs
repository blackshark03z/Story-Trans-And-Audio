...
try {
  ...
  process.stdout.write(JSON.stringify({ ok: true, journeyA, journeyB, journeyC, pollingStability, journeyDEdit, journeyDReview, journeyEPrepare, journeyEStart, journeyERunning, journeyF, journeyG, qaNullSafe, journeyH, inspectionBC, malformedSafe, desktop }));
} finally {
