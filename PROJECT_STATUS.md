...
**Cập nhật:** 2026-06-28T18:30 (Asia/Saigon)`n**Milestone:** Ready for Personal Production Use`n**Trạng thái:** Stable; chạy ``.\run_app.ps1`` để mở lại ``http://127.0.0.1:8766``
...
- Phase 3B Immutable Voice Snapshots: 14-field SegmentSynthesisInput with preset/custom-reference validation, fail-closed legacy policy, pipeline/retry snapshot preservation, 92 new tests (377 total), real VieNeu smoke (preset 1.04s + custom 4.31s), E2 waiver accepted. Phase 3B closure commit: this commit.
