...
**Cập nhật:** 2026-07-08T10:10 (Asia/Saigon)
**Milestone:** Task 12C1 Canonical Workflow Guard
**Trạng thái:** official verdict remains `PRODUCTION_GO`; unified workflow now has an explicit guarded canonical-production mode for real submit runs, while default behavior still refuses the canonical live root
...
**Last verified against commit:** `d4a2afe455f2a9a2f7afaa689f2d9bc3243b249a`
**Last verified branch:** `main`
**Last verified date:** 2026-07-08

**Last verified focused Task 12C1 baseline:**
- Full offline test suite baseline: 887 tests passing, 1 skipped
- Verification command: `unittest discover -s tests`
- Verified at commit: `d4a2afe455f2a9a2f7afaa689f2d9bc3243b249a`
...
- Task 12C1 local implementation adds explicit canonical unified-workflow mode behind `--allow-canonical-production`. The mode still fail-closes by default, requires explicit `--submit`, keeps exact approved Casting Plan identity checks, verifies `/api/runtime` canonical binding, and blocks duplicate pending/running jobs before any canonical production mutation.
