...
**Cập nhật:** 2026-07-07T17:05 (Asia/Saigon)
**Milestone:** Task 11D3B2 Local Ready
**Trạng thái:** active chapter playback now distinguishes canonical `ACTIVE AUDIO` from completed-job history, while job views and diagnostics clearly label `ACTIVE OUTPUT` versus `HISTORICAL` using the chapter artifact binding as source of truth
...
**Last verified against commit:** working tree after Task 11D3B2 local implementation, before local commit
...
- Verified at commit: Task 11D3B2 local working tree
