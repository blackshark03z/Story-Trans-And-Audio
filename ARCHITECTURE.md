...
Schema thực thi hiện tại là version 5; xem `docs/DATA_MODEL.md` và `story_audio/migrations/`. Các entity chính:
...
- Mỗi thay đổi schema DB đều có forward-only SQL migration checksum-locked; migration kế tiếp nếu cần là `0006_*`.
