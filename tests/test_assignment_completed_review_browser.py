...
'''
        ...
        self.assertEqual(
            ...
            "Đã duyệt · Duyệt hàng loạt: 0 chờ",
        )
        self.assertIn("Duyệt hàng loạt", evidence["completedBatch"])
