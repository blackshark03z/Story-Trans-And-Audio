...
class ApprovedReviewFixtureHandler(SpeakerReviewWorkspaceFixtureHandler):
    ...
    def registry(cls, book_id: int, start: int, end: int) -> dict:
        ...
        return {
            ...
            "characters": [{"id": 25, "display_name": "Hứa Thanh", "aliases": []}],
            "rows": [
