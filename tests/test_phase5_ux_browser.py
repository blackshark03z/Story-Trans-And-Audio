...
class Phase5UxBrowserTests(unittest.TestCase):
    def test_phase5_states_are_read_only_and_owner_task_first(self) -> None:
        ...
        self.assertEqual(evidence["humanQa"]["stage"], "Giai đoạn 5 / 5")
        self.assertTrue(evidence["humanQa"]["playerVisible"])
        self.assertTrue(evidence["humanQa"]["qaActionsAfterContext"])
        self.assertEqual(evidence["emptyNeedsFix"]["mutations"], [])
