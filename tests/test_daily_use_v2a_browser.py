...
'''
        ...
        self.assertEqual(evidence["compact"], {"firstRun": True, "workHidden": True, "primary": ["books", "production", "voices", "audio"], "secondary": "Cài đặt"})
