...
class ProductionWorkflowBrowserTests(unittest.TestCase):
    ...
    def test_range_input_exception_journeys_in_real_browser(self) -> None:
        ...
        self.assertTrue(evidence["scenarioASubmittingLayout"]["primaryVisible"])
        self.assertTrue(evidence["scenarioASubmittingLayout"]["statusVisible"])
        self.assertEqual(evidence["scenarioASubmittingLayout"]["scrollY"], 0)
