...
class ProductionWorkflowBrowserTests(unittest.TestCase):
    def test_task_workbench_journeys_in_real_browser(self) -> None:
        ...
        self.assertEqual(evidence["journeyB"]["primary"], ["Xử lý điều kiện còn thiếu"])
        self.assertEqual(evidence["journeyC"]["primary"], ["Xử lý điều kiện còn thiếu"])
        self.assertTrue(evidence["pollingStability"])
        self.assertEqual(evidence["journeyDEdit"]["primary"], ["Xử lý điều kiện còn thiếu"])
        self.assertEqual(evidence["journeyDReview"]["primary"], ["Xử lý điều kiện còn thiếu"])
        self.assertEqual(evidence["journeyEPrepare"]["primary"], ["Chuẩn bị audio"])
        ...
        self.assertEqual(evidence["journeyG"]["primary"], ["Nghe và duyệt"])
    ...
    def test_range_input_exception_journeys_in_real_browser(self) -> None:
        ...
        self.assertEqual(evidence["scenarioH"]["label"], "Chuẩn bị audio")
